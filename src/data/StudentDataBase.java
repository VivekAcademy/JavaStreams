...
public class StudentDataBase {
    ...
    public static Supplier<Student> studentSupplier = () -> {
       return new Student("Adam",2,3.6, "male",Arrays.asList("swimming", "basketball","volleyball"),2);
    };
    ...
    public static List<Student> getAllStudents(){
        ...
        Student student2 = new Student("Jenny",2,3.8,"female", Arrays.asList("swimming", "gymnastics","soccer"),16);
        /**
         * 3rd grade students
         */
